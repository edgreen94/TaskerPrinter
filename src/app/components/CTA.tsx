      ...
      <div className="max-w-7xl mx-auto">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-10 md:mb-12">
            The product is not broadly launched yet, but you can request access now and get updates as availability expands.
          </p>
        </div>

        <div className="max-w-5xl mx-auto grid gap-4 sm:grid-cols-2 mb-10 md:mb-12">
          <a
        ...
        <div className="max-w-5xl mx-auto mb-10 md:mb-12 grid gap-4 sm:grid-cols-2 md:grid-cols-3 text-left">
          <div className="rounded-2xl border border-border bg-card p-5">
            ...
            <p className="font-semibold">iPhone beta in active testing</p>
          </div>
          <div className="rounded-2xl border border-border bg-card p-5">
            <p className="text-sm text-muted-foreground mb-2">Next up</p>
            <p className="font-semibold">Android rollout planning underway</p>
          </div>
          <div className="rounded-2xl border border-border bg-card p-5 sm:col-span-2 md:col-span-1">
            ...
            <p className="font-semibold">Local Wi-Fi plus an ESC/POS printer</p>
          </div>
        </div>
        ...
        <div id="compatibility" className="max-w-5xl mx-auto bg-muted p-6 sm:p-8 rounded-2xl scroll-mt-20">
          ...
          <p className="text-muted-foreground mb-6">
            Ticker Printer is designed for ESC/POS-compatible 58mm and 80mm thermal receipt printers on the same local network.
            These are the models we would call out first:
          </p>
          ...
          <p className="mt-6 text-sm text-muted-foreground">
            If you are unsure about your setup, email your printer model and we can help you check fit before you buy.
          </p>
        </div>
      </div>
    </section>
