          ...
          return (
            <div key={step.number} className="relative">
              {index < steps.length - 1 && (
                <div
                  aria-hidden="true"
                  className="hidden md:block absolute top-16 left-1/2 w-full h-0.5 bg-gradient-to-r from-green-400 via-emerald-500 to-lime-400"
                  style={{ zIndex: 0 }}
                />
              )}
              <div className="relative z-10 flex flex-row items-start gap-5 text-left md:flex-col md:items-center md:text-center md:gap-0">
                <div className={`flex-shrink-0 inline-flex items-center justify-center w-16 h-16 md:w-24 md:h-24 bg-gradient-to-br ${step.gradient} text-white rounded-2xl shadow-xl md:mb-6`}>
                ...
                <div className="flex-1 min-w-0 md:w-full">
                  ...
                  <div aria-hidden="true" className="hidden md:block text-6xl font-bold text-muted/20 mb-2">{step.number}</div>
